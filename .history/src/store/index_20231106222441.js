...
export default createStore({
	state: {
		heroDisplay: [
			...
			{
				id: 2,
				picture: 'slider-img-spices.jpeg'
			},
            {
				id: 3,
				picture: 'slider-img-millets.jpeg'
			},
		],
		portfolio: [
			{
			...
			},
            {
                id: 3,
                name: "Millets",
                description: "Nutri cereals comprising of sorghum (jowar), pearl millet (bajra) and more. Nutritious and gluten-free subsitute to flour. It is also one of the oldest known food to man.",
