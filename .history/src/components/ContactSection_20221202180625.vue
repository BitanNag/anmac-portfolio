        ...
        <div class="body">
            <div class="form-container">
                <form @submit.prevent>
                    ...
                    <input type="text" placeholder="Full Name" class="name-input" v-model.lazy="name">
                    <input type="email" placeholder="Email" class="email-input" v-model.lazy="email">
                    <input type="number" placeholder="Phone Number" class="number-input" v-model.lazy="phoneNumber">
                    <textarea name="text" placeholder="Message" class="message-input" rows="14" cols="10" wrap="soft" maxlength="500" v-model.lazy="message"></textarea>
...
<script>
    export default {
        ...
        watch: {
            name(newValue) {
                if(newValue.replaceAll(/\s/g,'') === '') this.errorMessage = 'Please fill all fields correctly';
            ...
            phoneNumber(newValue) {
                if(String(newValue).replaceAll(/\s/g,'') === '') this.errorMessage = 'Please fill all fields correctly';
            },
        ...
        methods: {
            ...
            submitInput() {
                if(!this.name || !this.email || !this.phoneNumber || !this.message) {
                    ...
                    if(!(this.validateEmail(this.email) && this.validatePhoneNumber(this.phoneNumber))) this.errorMessage = 'Please fill all fields correctly';
                }
            }
        }
    }
